...
use stage::{signal::*, wavetable::WaveSignal};
    ...
    T: cpal::Sample,
{
    ...
    //let mut voices: Vec<Sine> = fb.fav(&[(440.0, 1.0), (880.0, 0.5)]);
    let mut signals: Vec<Box<dyn Signal>> =
        vec![Box::new(WaveSignal::sin(500.0, sample_rate as u32)), Box::new(WaveSignal::sin(250.0, sample_rate as u32))];
